...
namespace NetworkUtil
{
    ...
    public static class Networking
    {
        ...
        private static void AcceptNewClient(IAsyncResult ar)
        {
            ...
            server.BeginAcceptSocket(AcceptNewClient, ar.AsyncState);
        }
        ...
        public static void ConnectToServer(Action<SocketState> toCall, string hostName, int port)
        {
            ...
            try
            {
                ...
                if (!foundIPV4)
                {
                    throw new Exception($"DNS ERROR: NO IP Address was found for URL ({hostName}) !! ");
                }
            }
            catch (Exception ex0)
            {
            ...
            var state = new SocketState(toCall, socket);
